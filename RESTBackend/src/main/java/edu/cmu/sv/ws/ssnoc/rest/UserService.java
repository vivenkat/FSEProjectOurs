...
public class UserService extends BaseService {
    ...
    /**
     * This method is used to get the emergency status of a user
     *
     */
    @POST
    @Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    @Path("/{status}/status")
    public Response postStatus(@PathParam("status") String status, User user) {
        IUserDAO dao = DAOFactory.getInstance().getUserDAO();
    ...
    public String loadThisStatus(@PathParam("userName") String userName) {
        String status = null;
